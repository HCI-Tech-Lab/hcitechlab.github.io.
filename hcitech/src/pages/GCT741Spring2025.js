        ...
        <div className = "container-fluid mb-3">
            <div className="card h-100">
                <div className="card-header bg-secondary text-white">
                    <br /><br />
                    <center>
                    <h1 className="card-title">GCT623/MV623 Spring 2025<br />Interaction Sensing Principle & Application</h1></center><br /><br />
                </div>
                            ...
                            <table class="table table-bordered text-center text-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">Introduction to 3D Sesnor</td>
                                        <td class = "align-middle"></td>
                                        <td class = "align-middle"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle ">Vision-based Sensor: Stereo Vision I</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class = "align-middle table-info">Topic Presentation #1</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class = "align-middle">Digital Fringe Projection (1): Pinhole</td>
                                    ...
                                    <tr>
                                        ...
                                        Digital Fringe Projection (2): Phase</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-secondary align-middle">Digital Fringe Projection (3): phase unwrapping method & 3D reconstruction</td>
                                        <td class="align-middle"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>4/15</td>
                                        <td class="table-secondary align-middle">Digital Fringe Projection (4): 3D Data compression with phase</td>
                                        <td class = "align-middle"></td>
                                        <td class = "align-middle"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class = "align-middle">Pressure/Touch Sensor I</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class = "align-middle table-info">Project Progress Q&A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class = "table-info align-middle">Project Progress Feedback</td>
                                        <td class="align-middle">HW#4 Handout (<a href="https://klms.kaist.ac.kr/" target="_blank">KLMS</a>)<br/>
                                        <img src="../img/book-half.svg"/>Xu et al. <a href="https://dl.acm.org/doi/10.1145/3491102.3501904" target="_blank">"Enabling Hand Gesture Customization on Wrist-Worn Devices"</a>, CHI 2022</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">Inertial Measurement Unit Sensor</td>
                                        <td class="align-middle"></td>
                                        <td class="align-middle"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class = "align-middle">Pressure/Touch Sensor II</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class = "align-middle">Topic Presentation#5<br/>Bioacoustic Sensing</td>
                                        <td class = "align-middle"></td>
                                        <td class = "align-middle"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class = "align-middle">Topic Presentation#5</td>
                                        <td class = "align-middle"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-info align-middle">Final Presentation Preparation Q&A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle table-info">Final Presentation Feedback</td>
                                        <td class = "align-middle"></td>
