...
export default function RecruitingGrad() {
    return (
        <SectionContainer>
            ...
            <h5 style={{marginLeft: "10px", paddingBottom: "20px"}}> Refer to recent <Link href="../publication.html" target="_blank"><b>papers</b></Link> for examples. </h5>
            </p>
