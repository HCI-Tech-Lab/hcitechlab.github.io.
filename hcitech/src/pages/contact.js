    ...
    return (
      <div>
        ...
        <SectionContainer>
          ...
          <p></p>
          <Link className="badge bg-primary" href="https://hcitech.org/recruiting/recruiting_graduate.html" style={{width: "15.5rem", height: "2.2rem", fontSize: "1.2rem" }} target="_blank">M.S./Ph.D. Students</Link>
        </SectionContainer>
      </div>
    );
  }